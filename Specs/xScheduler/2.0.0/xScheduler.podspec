...
Pod::Spec.new do |s|
  ...
  s.description  = "the Scheduler Module for iOS Application (for Swift 3.0)."
  ...
  s.resources = ["xScheduler/**/*.extension","xScheduler/**/*.xib","xScheduler/**/*.xcassets","xScheduler/**/*.lproj","xScheduler/**/*.xcdatamodeld"]
