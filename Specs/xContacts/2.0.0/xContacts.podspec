...
Pod::Spec.new do |s|
  ...
  s.description  = "the Contacts Module for iOS Application (for Swift 3.0)."
  ...
  s.source  = { :hg => "http://Guest:Guest@bjhyzy2015.imwork.net:808/hg/D:/datacenter/xContacts",:branch => "2.0.0"}
