...
Pod::Spec.new do |s|
  ...
  s.description  = "the Contacts Module for iOS Application."

  s.homepage     = "https://github.com/bjhyzy/xContacts"
  ...
  s.source  = { :hg => "http://liuquanbin:liuquanbin2016@bjhyzy2015.imwork.net:808/hg/D:/datacenter/xContacts"}
  ...
  s.source_files  = "xContacts", "xContacts/**/*.{h,swift}"
  ...
  s.resources = ["xContacts/**/*.extension","xContacts/**/*.xib","xContacts/**/*.xcassets"]
