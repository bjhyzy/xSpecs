...
Pod::Spec.new do |s|
  ...
  s.description  = "the location for iOS Application  (for Swift 3.0)."

  s.homepage     = "https://github.com/bjhyzy/xLocation"
  ...
  s.source  = { :hg => "http://Guest:Guest@bjhyzy2015.imwork.net:808/hg/D:/datacenter/xLocation", :branch => "1.0.0" }
  ...
  s.source_files  = "xLocation", "xLocation/**/*.{h,swift}"
