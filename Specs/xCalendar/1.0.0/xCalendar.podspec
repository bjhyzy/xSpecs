...
Pod::Spec.new do |s|
  ...
  s.description  = "the Calendar Module for iOS Application."
  ...
  s.source  = { :hg => "http://Guest:Guest@bjhyzy2015.imwork.net:808/hg/D:/datacenter/xCalendar"}
  ...
  s.resources = ["xCalendar/**/*.extension","xCalendar/**/*.xib","xCalendar/**/*.xcassets"]
