...
Pod::Spec.new do |s|
  ...
  s.source  = { :hg => "http://liuquanbin:liuquanbin2016@bjhyzy2015.imwork.net:808/hg/D:/datacenter/xFramework"}
  ...
  s.resources = ["xFramework/**/*.extension","xFramework/**/*.xib","xFramework/**/*.xcassets"]
