...
Pod::Spec.new do |s|
  ...
  s.description  = "the framework for iOS Application."
  ...
  s.source  = { :hg => "http://Guest:Guest@bjhyzy2015.imwork.net:808/hg/D:/datacenter/xFramework"}
  ...
  s.resources = ["xFramework/**/*.extension","xFramework/**/*.xib","xFramework/**/*.xcassets","xFramework/**/*.strings"]
  ...
  # s.xcconfig = { "HEADER_SEARCH_PATHS" => "$(SDKROOT)/usr/include/libxml2" }
   ...
   s.dependency 'Localize-Swift', '1.5'
   s.dependency 'NVActivityIndicatorView', '2.12'
   s.dependency 'Proposer', '0.9.1'
   s.dependency 'JVFloatLabeledTextField'
   s.dependency 'AEXML', '3.0.0'
   s.dependency 'FontAwesome.swift', '0.9.0'
