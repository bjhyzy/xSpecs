...
Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/bjhyzy/WRCalendarView'
  s.screenshots      = ['https://github.com/bjhyzy/WRCalendarView/blob/master/Example/Screenshots/1.png',
                        '(https://github.com/bjhyzy/WRCalendarView/blob/master/Example/Screenshots/1.gif']
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wayfinder' => 'wayfinder12@gmail.com' }
  s.source           = { :git => 'https://github.com/bjhyzy/WRCalendarView.git'}
